...
import com.css.util.DataSourceTypeManager;
...
public class DataSourceInterceptor {
    ...
    @Pointcut("execution(public * com.css.service.DataRepairService.queryDataRepairList(..))")
    public void mysqlDataSource(){

    };

    @Before("mysqlDataSource()")
    public void before(JoinPoint jp){
        DataSourceTypeManager.set(DataSourceEnum.MYSQL);
    }
    //...
