    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <section class="content-header">
                <h2 class="sub-header">任务运维列表(<span class="text-primary" id="project_name" ><c:out value="${project}"/></span>)</h2>
            ...
            <section class="content">
                <div class="row clearfix" style="margin-bottom: 20px">
                    ...
                    <div class="row">
                        ...
                        <div  class="col-md-3">
                            ...
                            <button id="search_operator" type="button" class="btn btn-default">
                ...
                <div class="row clearfix" style="margin-bottom: 20px">
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <button id="fulltask" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>全部任务
                            </button>
                            <button id="notrunning" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>未运行
                            </button>
                            <button id="waitingtime" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>等待时间
                            </button>
                            <button id="waitingresources" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>等待资源
                            </button>
                            <button id="failed" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>失败
                            </button>
                            <button id="running" type="button" class="btn btn-default">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>运行中
                            </button>

                        </div>
                        <span>&nbsp;</span>
                        <button id="goback" type="button" class="btn btn-tumblr">
                            <span class="glyphicon glyphicon-glass" aria-hidden="true"></span>返回主页
                        </button>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div id="toolbar" class="btn-group">
                                    <button id="kill" type="button" class="btn btn-danger">
                                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>终止任务
                                    </button>
                                    <button id="rerun" type="button" class="btn btn-warning">
                                        <span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>重跑任务
                                    </button>
                                    <button id="succeed" type="button" class="btn btn-success">
                                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>置成功
                                    </button>
                                </div>
